...
$(builddir)/mono.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/mono.node: LIBS := $(LIBS)
$(builddir)/mono.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/mono.node: TOOLSET := $(TOOLSET)
$(builddir)/mono.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/mono.node
# Add target alias
.PHONY: mono
mono: $(builddir)/mono.node

# Short alias for building this executable.
.PHONY: mono.node
mono.node: $(builddir)/mono.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/mono.node
